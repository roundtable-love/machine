...
**Environment:** Aalto University, Finland **Nodes:** Linus Torvalds (Initiator)
vs. NVIDIA (Receiver)
...
- **Technical:** "NVIDIA is deprecated as a compatible partner due to
  non-compliance with open standards. Connection terminated."
- **Educational (jam):** "NVIDIA nuh waan play fair. Linus just lif' up di
